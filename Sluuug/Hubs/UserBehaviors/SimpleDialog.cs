...
namespace Sluuug.Hubs
{
    ...
    {
        public SimpleDialog(HubCallerContext context, IHubCallerConnectionContext<dynamic> clients)
        {
            this.Context = context;
            this.Clients = clients;
        }

        public async Task<NotificationModel> SendMessage(string message, string convId, int toUserId)
        {
