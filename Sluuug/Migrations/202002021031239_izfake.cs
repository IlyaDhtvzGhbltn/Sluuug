namespace Slug.Migrations
{
    ...
    public partial class izfake : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        ReferalUserId = c.Int(),
                        IsFakeBot = c.Boolean(nullable: false),
                        Settings_Id = c.Int(),
                ...
                c => new
                    {
                        ...
                        IdOkUser = c.Long(nullable: false),
                        VipStatusExpiredDate = c.DateTime(),
                    })
                .PrimaryKey(t => t.Id);
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Guid(nullable: false, identity: true),
                        UserPosted = c.Int(nullable: false),
